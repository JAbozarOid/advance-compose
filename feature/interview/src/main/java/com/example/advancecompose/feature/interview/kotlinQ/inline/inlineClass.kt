...
// This annotation is required to tell the JVM that the class should be inlined (i.e., no object created)
// You need lightweight domain models
// a value class or inline class is a lightweight wrapper around a single value
